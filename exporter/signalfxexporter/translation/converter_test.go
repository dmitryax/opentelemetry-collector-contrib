		...
		},
		{
			...
			wantSfxDataPoints: []*sfxpb.DataPoint{
				doubleSFxDataPoint(
					...
					tsMSecs,
					&sfxMetricTypeGauge,
					append([]string{"cloud.account.id", "cloud.provider", "cloud.region", "k/r0", "k/r1"}, keys...),
		...
		},
		{
			...
			wantSfxDataPoints: []*sfxpb.DataPoint{
				doubleSFxDataPoint(
					...
					tsMSecs,
					&sfxMetricTypeGauge,
					append([]string{"AWSUniqueId", "k/r0", "k/r1"}, keys...),
		...
		},
		{
			...
			wantSfxDataPoints: []*sfxpb.DataPoint{
				doubleSFxDataPoint(
					...
					tsMSecs,
					&sfxMetricTypeGauge,
					append([]string{"cloud.provider", "host.id", "k/r0", "k/r1"}, keys...),
		...
		},
		{
			...
			wantSfxDataPoints: []*sfxpb.DataPoint{
				doubleSFxDataPoint(
					...
					tsMSecs,
					&sfxMetricTypeGauge,
					append([]string{"gcp_id", "k/r0", "k/r1"}, keys...),
